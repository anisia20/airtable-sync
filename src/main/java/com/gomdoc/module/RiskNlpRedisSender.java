...
@JBossLog
public class RiskNlpRedisSender extends DaemonG {

	DeamongService parent;
	SignalResourceManager resourceManager;
	
	public RiskNlpRedisSender(DeamongService parent, SignalResourceManager resourceManager, String name) {
		setName(name);
		this.parent = parent;
...
//		}
	...
	public void execute() {
		...
		String redisstr = resourceManager.getRedisCmd().pop(Def.REDIS_Q_NLP_RISKKEYWORD_SEND);
